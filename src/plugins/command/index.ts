 ...
 * @LastEditTime: 2021-10-05 18:33:14
 * @LastEditors: vyron
 * @Description: Bot command plugin
 * @FilePath: /wechat-bot/src/plugins/command/index.ts
 */
// @ts-ignore
import {config, Message, Room, Wechaty} from "/wechaty";
import {isOwner, BLANK} from "../../utils";
...
const weather = async (msg: Message, command: string) => {
	...
	await sendWeatherMessage(configs[talkerConfigIndex], msg);
};
